...
<section class="contactme">
  <div id="fancy-inputs">
    ...
    <!--  <label class="input">
      ...
      <input type="submit" value="Enviar" class="btn-contactme cta">
      </label> -->

      <div class="input" style="margin:15% 0 25% 0">
      ...
      <a class="btn" style="width: 100%;margin-bottom: 10px;" href="mailto:direccion@destinatario.com">Envíanos un mensaje</a>
      
      <div>
        <div class="text-center" style="width: 31%;display: inline-block;font-size: 15px;">
          <a target="_blank">
            <img src="https://png.icons8.com/color/500/whatsapp.png" width="35px" style="position: static;" /><br>963 122 7005<br><br><br>
          </a>
        </div>
        <div class="text-center" style="width: 67%;display: inline-block;font-size:  15px;">
